...
import com.example.telegramdiplom.ui.message_recycler_view.view_holders.*
...
class GroupChatAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
   ...
   // private lateinit var mDiffResult: DiffUtil.DiffResult
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) { //принимает holder, передает position, функция drawMessage отрисовует сообщения
